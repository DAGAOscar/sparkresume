...
export const TechFocusedTemplate: React.FC<TechFocusedTemplateProps> = ({ data }) => {
  return (
    <div className="w-full bg-gradient-to-br from-slate-900 to-slate-800 text-white p-4 md:p-6 lg:p-8" style={{ fontFamily: 'var(--font-plus-jakarta), sans-serif', fontSize: '15px', lineHeight: '1.6', letterSpacing: '-0.3px' }}>
      {/* Header */}
      <div className="mb-4 md:mb-6 lg:mb-8 pb-3 md:pb-4 lg:pb-6 border-b border-cyan-500">
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-cyan-400 mb-3" style={{ fontFamily: 'var(--font-playfair)', fontWeight: 700, letterSpacing: '-0.5px' }}>{data.name}</h1>
      ...
      <div className="mb-4 md:mb-6 lg:mb-8">
        ...
        <div className="space-y-1">
          {data.skills.map((skill, idx) => (
            <div key={idx} className="text-xs md:text-sm text-gray-300 flex items-center gap-2">
      ...
      <div className="mb-4 md:mb-6 lg:mb-8">
        ...
        <div className="space-y-4">
          {data.experience.map((exp, idx) => (
            <div key={idx} className="bg-slate-700/50 p-2 md:p-3 rounded border-l-2 border-cyan-500">
