...
export const ExecutiveSummaryTemplate: React.FC<ExecutiveSummaryTemplateProps> = ({ data }) => {
  return (
    <div className="w-full bg-white text-gray-900 p-4 md:p-6 lg:p-8" style={{ fontFamily: 'var(--font-plus-jakarta), sans-serif', fontSize: '15px', lineHeight: '1.6', letterSpacing: '-0.3px' }}>
      {/* Header */}
      <div className="text-center mb-4 md:mb-6 lg:mb-8 pb-3 md:pb-4 lg:pb-6 border-b-4 border-teal-600">
        <h1 className="text-2xl md:text-3xl lg:text-3xl font-bold mb-4 text-teal-700" style={{ fontFamily: 'var(--font-playfair)', fontWeight: 700, letterSpacing: '-0.4px' }}>{data.name}</h1>
      ...
      {data.summary && (
        <div className="mb-4 md:mb-6 lg:mb-8">
          <h2 className="text-base md:text-lg font-bold text-teal-700 uppercase mb-3">Executive Profile</h2>
      ...
      <div className="mb-4 md:mb-6 lg:mb-8">
        <h2 className="text-base md:text-lg font-bold text-teal-700 uppercase mb-4">Professional Achievements</h2>
        <div className="space-y-4">
          {data.experience.map((exp, idx) => (
            <div key={idx} className="pl-2 md:pl-5 border-l-4 border-teal-400">
      ...
      {/* Education */}
      <div className="mb-4 md:mb-6 lg:mb-8">
        <h2 className="text-base md:text-lg font-bold text-teal-700 uppercase mb-4">Academic Background</h2>
      ...
      {/* Competencies */}
      <div className="mb-4 md:mb-6 lg:mb-8">
        <h2 className="text-base md:text-lg font-bold text-teal-700 uppercase mb-3">Core Competencies</h2>
      ...
      {data.languages && data.languages.length > 0 && (
        <div className="mb-4 md:mb-6 lg:mb-8">
          <h2 className="text-base md:text-lg font-bold text-teal-700 uppercase mb-3">Linguistic Proficiency</h2>
